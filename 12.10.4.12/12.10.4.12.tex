...
\section{Solution}
\begin{align}
\vec{A} &= \myvec{-1\\[1pt]\frac{1}{2} \\[1pt] 4} \\
\vec{B} &= \myvec{1\\[1pt]\frac{1}{2} \\[1pt] 4} \\
\vec{C} &= \myvec{1\\[1pt]\frac{-1}{2} \\[1pt] 4}\\
\vec{D} &= \myvec{-1\\[1pt]\frac{-1}{2} \\[1pt] 4}
\end{align}
\begin{align}
\vec{A} - \vec{B} &= \myvec{-2\\0\\0}\\
\vec{D} - \vec{C} &= \myvec{-2\\0\\0}\\
\vec{C} -\vec{B} &= \myvec{0\\-1\\0}\\
\vec{D} -\vec{A} &= \myvec{0\\-1\\0}
\end{align}

$\therefore$, the sides $\vec{A} -\vec{B}$ and $\vec{C}-\vec{B}$ are adjacent.

Area of the rectangle,
\begin{align}
Area &= \|\vec{A} -\vec{B}\| \; \| \vec{C}-\vec{B}\|\\
&= 2
\end{align} 
