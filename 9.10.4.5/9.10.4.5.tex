...
Also, $\vec{A}$ and $\vec{C}$ are equidistant (6m) from $\vec{B}$, we can say that they lie on the circle having $\vec{B}$ as center and radius 6m.Equation of this circleis given by,
\begin{align}
...
Solution for $\vec{A}$ and $\vec{C}$ from \eqref{eq:1} and \eqref{eq:2},
\begin{align}
	\myvec{5&0} \vec{x} &= 18\\
	\norm{\vec{x}} &= 36 \\
	\therefore, \vec{x} = \myvec{\frac{18}{5} \\[1pt] \pm \frac{24}{5}}\\
	\vec{A} = \myvec{\frac{18}{5} \\[1pt] \frac{24}{5}} \; \vec{C} = \myvec{\frac{18}{5} \\ -\frac{24}{5}} 
\end{align}
