...
Direction cosines,
\begin{align}
\vec{m} = \myvec{\cos{\theta}_1 \\ \cos{\theta}_2 \\ \cos{\theta}_3 } = \myvec{\cos{\theta} \\ \cos{\theta} \\ \cos{\theta} }
\end{align}

we know that 
\begin{align}
\norm{\vec{m}} &= 1\\
\abs{\sqrt{3} \cos{\theta}} &=1\\
\cos{\theta} &= \pm \frac{1}{\sqrt{3}}\\
\vec{m} &= \pm \myvec{\frac{1}{\sqrt{3}} \\[1pt] \frac{1}{\sqrt{3}} \\[1pt] \frac{1}{\sqrt{3}}}
\end{align}

\begin{figure}[h!]
  \centering
   \includegraphics[width=\columnwidth]{figs/Figure_1.png}
   \caption{vector OA, that makes equal angles with axes}
   \label{fig:}
\end{figure}
