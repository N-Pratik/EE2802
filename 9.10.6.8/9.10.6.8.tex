...
\item Let the vertices of the triangle ABC be:
	...
	\end{align}
		For ease of calculation let's assume a = 5, c = 3, $\theta = 60{\degree}$.
...
\item Circumcenter of triangle ABC:\\
	...
	Therefore, the circumcenter is given by:
		\begin{align}
			\myvec{ a & 0\\ c \cos{\theta} & c \sin{\theta}} \vec{x} &= \myvec{ \frac{a^2}{2} \\ \frac{c^2}{2}}\\
			\vec{x} &= \myvec{ \frac{5}{2} \\[1pt] -\frac{2}{\sqrt{3}}} 
		\end{align}
\item Incenter of triangle ABC:
	\begin{align}
		\vec{I} &= \frac{a \vec{A} + b\vec{B} + c \vec{C}}{a+b+c}\\
		&= \frac{15\sqrt{3}}{2} \myvec{\sqrt{3} \\1}  
	\end{align}
