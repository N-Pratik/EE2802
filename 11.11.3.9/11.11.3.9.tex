...
\begin{align}
	\vec{n} &= \text{direction vector of major axis}\\
		&= \myvec{1\\0} \label{eq:1}
\end{align}
\begin{align}
	\vec{V} &= \norm{\vec{n}}^2 \vec{I} - e^2 \vec{n} \vec{n}^{\top} = \myvec{\frac{4}{9}&0\\0&1}\\	\label{eq:2}
	\vec{u} &= ce^2 \vec{n} - \norm{\vec{n}}^2\vec{F} = \myvec{0\\0}\\	\label{eq:3}
	f &= \norm{\vec{n}}^2 \norm{\vec{F}}^2 - c^2e^2  = -4	\label{eq:4}
\end{align}
