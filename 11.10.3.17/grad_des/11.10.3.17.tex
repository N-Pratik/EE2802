...
\item Optimization problem
	...
	\begin{align}
		\frac{\partial f(\vec{x})}{\partial \vec{x}} &= 2 \brak{\vec{x} - \vec{A}}
	\end{align}

	But due to the constraint, only the component orthogonal to $\vec{n}$ is considered. Hence, the gradient is updated as

	\begin{align}
		\text{grad} &= -2 \brak{ \brak{\vec{x} -\vec{A}} - \frac{\vec{n}^{\top}\brak{\vec{x} - \vec{A}}}{\norm{\vec{n}}} \vec{n}} 
	\end{align}

	The parameter $\vec{x}$ is updated using the following equation,

	\begin{align}
		\mu &= \mu - \alpha \times \text{grad}
	\end{align}
...
Where $\alpha$ is the learning rate.
		...
		\begin{align}
			\vec{x}_{min} & = \myvec{ 1.00039877 \\ 1.99960123}\\
