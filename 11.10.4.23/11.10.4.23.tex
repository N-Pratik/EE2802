...
\begin{align}
	\vec{m} =\myvec{\frac{\sin{\theta}}{b} \\ \frac{\cos{\theta}}{a} } 
\end{align}
...
\begin{align}
	d_1 &= \frac{\vert n^{\top} \vec{P} -  c \vert }{\norm{\vec{n}}} \\
	d_1 &= \frac{ \vert \frac{\cos{\theta}\sqrt{a^2-b^2}}{a}-1 \vert }{ \sqrt{ \frac{\cos^2{\theta}}{a^2} +\frac{\sin^2{\theta}}{b^2} }}\\
\end{align}

\begin{align}
	d_2 &= \frac{\vert n^{\top} \vec{Q} -  c \vert }{\norm{\vec{n}}} \\
	d_2 &= \frac{\vert \frac{\cos{\theta}\sqrt{a^2-b^2}}{a}+1 \vert}{\sqrt {\frac{\cos^2{\theta}}{a^2} +\frac{\sin^2{\theta}}{b^2} }}\\
\end{align}


\begin{align}
	d_1d_2 &=\frac{\vert \frac{\cos^2{\theta}\brak{a^2-b^2}}{a^2}- 1 \vert}{\frac{\cos^2{\theta}}{a^2} +\frac{\sin^2{\theta}}{b^2} }\\ 
