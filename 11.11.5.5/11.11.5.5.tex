...
A rod of length 12cm moves with its ends always touching the coordinate axes. Determine the equation of locus of a point  P on the rod, which is 3cm from the end in contact with $x-axis$.

\section{Solution}

let the angle made by the rod with x-axis be $\theta$\\
The x-intecept and y-intercept of rod will be:\\
\begin{enumerate}
